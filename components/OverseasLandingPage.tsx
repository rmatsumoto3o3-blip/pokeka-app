        ...
        <>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                <div className="mb-1 flex items-center gap-2">
                                    ...
                                    <span className="rounded bg-amber-100 px-2 py-0.5 text-[10px] font-semibold text-amber-800">DRY RUN</span>
                                </div>
            ...
            <main className="mx-auto grid max-w-[1080px] grid-cols-1 gap-4 px-3 py-4 md:grid-cols-[1fr_260px]">
                ...
                <aside className="space-y-3">
                    ...
                    <div className="rounded-lg border border-amber-200 bg-amber-50 p-3.5 text-[10px] leading-relaxed text-amber-800"><strong className="block text-xs">モック表示中</strong>現在の選手名・大会・集計値は画面確認用です。Supabase、Google Sheets、Limitless APIには接続していません。</div>
                    <div className="rounded-lg border border-sky-200 bg-sky-50 p-3.5 text-[10px] leading-relaxed text-sky-800">カード名は英語を正として表示します。確認できたカードだけ日本語名を補助表示します。</div>
                </aside>
            </main>
        </>
    )
