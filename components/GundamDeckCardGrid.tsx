...
import type { GundamCard } from '@/lib/gundamDeckParser'

interface GundamDeckCardGridProps {
    cards: GundamCard[]
}

export default function GundamDeckCardGrid({ cards }: GundamDeckCardGridProps) {
    const [selected, setSelected] = useState<GundamCard | null>(null)
