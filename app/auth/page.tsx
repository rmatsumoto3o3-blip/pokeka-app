            ...
            <div className="w-full max-w-md p-6 md:p-8 bg-white rounded-2xl shadow-sm border border-[#e2e8f0]">
                ...
                <form onSubmit={handleAuth} className="space-y-4">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full py-3 px-4 bg-white hover:bg-gray-50 text-gray-700 font-semibold rounded-lg shadow-md border border-gray-300 flex items-center justify-center gap-3 transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50"
                    >
