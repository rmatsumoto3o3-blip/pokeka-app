            ...
            <div className="max-w-4xl mx-auto space-y-8 py-12 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition font-mono text-sm bg-gray-50/50"
                            />
                        </div>
                        <button
                            onClick={handleParse}
                            ...
                            className={`w-full py-4 rounded-xl font-bold text-white transition-all shadow-lg flex items-center justify-center space-x-2
                                ${loading || !inputText.trim()
                                    ...
                                    : 'bg-gradient-to-r from-blue-500 to-blue-600 hover:scale-[1.02] active:scale-[0.98]'
                                }`}
                        >
                            {loading ? (
                ...
                {cards.length > 0 && (
                    <div className="space-y-8 animate-in fade-in zoom-in duration-500">
                        <div className="bg-white/80 backdrop-blur p-4 rounded-xl flex justify-between items-center border border-blue-100 shadow-sm">
                            <button
                                onClick={() => setCards([])}
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                                    <h4 className="font-bold text-blue-800 mb-1">Ball Search Counts</h4>
                                    <p className="text-sm text-blue-700">Useful for optimizing the count of Nest Balls, Ultra Balls, etc., to ensure you find Basic Pokémon.</p>
                                </div>
                                <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                                    <h4 className="font-bold text-blue-800 mb-1">Consistency Check</h4>
                                    <p className="text-sm text-blue-700">Visualize "brick" rates (unplayable hands) when you reduce Energy or Supporter counts.</p>
                                </div>
                            </div>
                        </div>
                    </div>
