...
export default function PrivacyPolicy() {
    ...
    return (
        <div className="min-h-screen bg-pink-50 py-12 px-4">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl p-8 border-2 border-pink-200 shadow-sm">
                <h1 className="text-3xl font-bold text-gray-900 mb-8">プライバシーポリシー</h1>

                <div className="space-y-6 text-gray-700">
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-3">1. 個人情報の収集について</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-3">2. Cookieの使用について</h2>
                        <p className="leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-3">3. 広告配信について</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-3">5. データの保存について</h2>
                        <p className="leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-3">6. データの削除について</h2>
                        <p className="leading-relaxed">
