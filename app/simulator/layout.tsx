...
export const metadata: Metadata = {
  // タイトルは短く。共通テンプレの「| PokéLix（ポケリス）」が付くため、
  // ここが長いと検索結果で末尾が切れてCTRが落ちる（実測: 27字→CTR5.0%、9字の/practiceは12.5%）。
  title: 'ポケカ シミュレーター（初手確率）',
  description: 'デッキコードを入力するだけで、初手7枚に欲しいカードが来る確率・サイド落ち・マリガン率をモンテカルロ法（10万回試行）で即計算。無料のポケカ確率シミュレーターです（「ポケカ シュミレーター」とも呼ばれます）。',
