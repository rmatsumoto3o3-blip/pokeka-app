                    ...
                    <div className="bg-white rounded-xl shadow-lg p-4 mb-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                {canShowCpuUnlock && (
                                    <div className="mt-2 rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-xs font-bold text-blue-700">
    ...
    const renderZoneCard = (
        ...
        return (
            ...
            >
                ...
                {toolCount > 0 && (
                    <div className="absolute right-1 top-1 rounded-full bg-blue-300 px-1.5 py-0.5 text-[10px] font-black text-gray-950 shadow">
                        道具{toolCount}
                    </div>
                )}
                {hpSummary && (
                ...
                {attachmentSummary.length > 0 && (
                    <div className="mt-1 grid gap-1">
                        ...
                        {toolCount > 0 && (
                            <div className="line-clamp-2 rounded bg-blue-300/95 px-1.5 py-0.5 text-[10px] font-bold leading-tight text-gray-950">
